...
## Drivers of Mapping Simulation
### gradients_setup.py
Drives the mapper.py and sim_tools.py code to generate a specific mutant condition.
  
### vid_tri_inject.py & tri_inject_sim.py
Uses the simulated topographic maps to generate figures representing triple injection experiments, either video or stills. Injections can be performed in the source or target tissue, representing anterograde and retrograde focal injection experiments, respectively.
